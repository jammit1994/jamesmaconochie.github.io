...
1. **Observation:** A real, exciting breakthrough (a qubit entangled, a neuron simulated).
2. **Extrapolation:** Extend the curve, "We'll soon simulate the entire brain."
3. **Assumption:** Treat scaling as understanding, "More compute equals more mind."
4. **Narrative:** Frame the future as inevitable, "Uploading consciousness is only a matter of time."
5. **Reward:** Capture public imagination (and often, funding momentum).
